...
class Request {
    ...
    public function __call($method, $args)
    {
        if (array_key_exists($method, self::$hook)) {
            ...
            return PLiteException::throwing('method not exists:' . __CLASS__ . '->' . $method);
        }
    }
    ...
    {
        isset($filter) and $this->filter = $filter;
        return $this->filter;
    }
    ...
    {
        empty($route) or $this->routeInfo = $route;
