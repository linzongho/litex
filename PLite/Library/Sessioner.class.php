...
class Sessioner {
    ...
    /**
     * @param \SessionHandlerInterface|null $driver
     */
    public static function __init(\SessionHandlerInterface $driver=null) {
        $isDoStart = false;
        ...
        if (isset($config['cache_expire'])) {
            ...
            // 检查驱动类
        $driver and session_set_save_handler($driver) or PLiteException::throwing('error session handler');//and > or
        $isDoStart and session_start();
    }
