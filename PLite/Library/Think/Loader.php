...
class Loader
{
    ...
    public static function register($autoload = '')
    {
        ...
        // 注册命名空间定义
        self::addNamespace([
            'think'    => LIB_PATH . 'think' . DIRECTORY_SEPARATOR,
            'behavior' => LIB_PATH . 'behavior' . DIRECTORY_SEPARATOR,
            'traits'   => LIB_PATH . 'traits' . DIRECTORY_SEPARATOR,
        ]);
        // 加载类库映射文件
        ...
        // 自动加载extend目录
        self::$fallbackDirsPsr4[] = rtrim(EXTEND_PATH, DIRECTORY_SEPARATOR);
    }
    ...
    public static function import($class, $baseUrl = '', $ext = EXT)
    {
        ...
        if (empty($baseUrl)) {
            ...
            if (isset(self::$prefixDirsPsr4[$name . '\\'])) {
                ...
                // 加载其它模块的类库
                $baseUrl = APP_PATH . $name . DIRECTORY_SEPARATOR;
            }
