    ...
    public static function run(Request $request = null)
    {
        ...
        try {
            ...
            if ($config['lang_switch_on']) {
                ...
                // 加载系统语言包
                Lang::load(THINK_PATH . 'lang' . DIRECTORY_SEPARATOR . $request->langset() . EXT);
                if (!$config['app_multi_module']) {
                    Lang::load(APP_PATH . 'lang' . DIRECTORY_SEPARATOR . $request->langset() . EXT);
                }
            }
    ...
    private static function init($module = '')
    {
        ...
        if (is_file(APP_PATH . $module . 'init' . EXT)) {
            ...
            if ($config['lang_switch_on'] && $module) {
                Lang::load($path . 'lang' . DIRECTORY_SEPARATOR . Request::instance()->langset() . EXT);
            }
        }
        return Config::get();
    }
